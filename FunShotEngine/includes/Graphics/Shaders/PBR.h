...
namespace Gen
{
    ...
    {        
        GEN_INLINE PbrShader(const std::string& filename): Shader(filename) 
        {
        ...
        GEN_INLINE void SetEnvMaps(uint32_t irrad, uint32_t prefil, uint32_t brdf, uint32_t depthMap)
        {
        ...
        GEN_INLINE void SetDirectLight(DirectLight& light, Transform3D& transform, int32_t index) 
        {
        ...
        GEN_INLINE void SetPointLight(PointLight& light, Transform3D& transform, int32_t index) 
        {
        ...
        GEN_INLINE void SetSpotLight(SpotLight& light, Transform3D& transform, int32_t index) 
        {
        ...
        GEN_INLINE void SetJoints(std::vector<glm::mat4>& joints) 
        {
        ...
        GEN_INLINE void Draw(Model3D& model, Material& mtl, Transform3D& transform)
        {
            // set transform
        ...
        GEN_INLINE void SetCamera(Camera3D& camera, Transform3D& transform, float ratio) 
        {
        ...
        GEN_INLINE void SetLightSpaceMatrix(const glm::mat4& lightSpaceMtx)
        {
...
private:
        GEN_INLINE void UseMap(uint32_t map, uint32_t uniform, int32_t unit) 
        { 
        ...
        GEN_INLINE void SetMaterial(Material& mtl, int32_t unit) 
		{
			// set usability
