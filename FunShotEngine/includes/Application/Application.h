...
namespace FS
{
    ...
    private:   
        ...
        {      
            ...
            auto GuyScriptAsset = m_Context->Assets->AddScript(RandomU64(), "Resources/Scripts/GuyScript.lua");
            ...
            light.Attach<InfoComponent>().Name = "Direct Light";
            ...
            robot.Attach<InfoComponent>().Name = "Guy";
            robot.Attach<ScriptComponent>().Script = GuyScriptAsset->UID;
            ...
            plane.Attach<InfoComponent>().Name = "Plane";
            ...
            tp.Translate = glm::vec3(0.0f, 0.0f, 0.0f);
