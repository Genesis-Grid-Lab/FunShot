...
// starts input field
GEN_INLINE void BeginInput(const char* label)
{
    ImGui::PushID(label);
...
GEN_INLINE bool InputBool(const char* label, bool* value) 
{
    BeginInput(label);        
...
GEN_INLINE bool InputFloat(const char* label, float* value) 
{
    BeginInput(label);        
...
GEN_INLINE bool InputVec3(const char* label, glm::vec3* value) 
{
    BeginInput(label);        
...
// shows bool input field
GEN_INLINE bool InputColor(const char* label, float* value) 
{
    BeginInput(label);        
...
// shows button
GEN_INLINE bool InputButton(const char* label, ImVec2& size = ImVec2(0,0)) 
{
...
GEN_INLINE bool InputCombo(const char* label, const std::vector<const char*>& combos) 
{
    BeginInput(label);    
...
GEN_INLINE bool InputText(const char* label, char* value, const char* hint = nullptr, size_t size = 32) 
{
    BeginInput(label);    
