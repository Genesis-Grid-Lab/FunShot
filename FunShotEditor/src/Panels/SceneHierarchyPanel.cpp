...
namespace FS {
    ...
    SceneHierarachyPanel::SceneHierarachyPanel(const Ref<Scene> &context){
        SetContext(context);
    }

    void SceneHierarachyPanel::SetContext(const Ref<Scene> &context){
        m_Context = context;
        m_SelectionContext = {};
    }

    void SceneHierarachyPanel::OnImGuiRender(){
    ...
    void SceneHierarachyPanel::DrawEntityNode(Entity entity){
    ...
    static void DrawComponent(const std::string& name, Entity entity, UIFunction uiFunction){
        ...
        if(entity.HasComponent<T>()){
            ...
            ImVec2 contentReginAvail = ImGui::GetContentRegionAvail();
            ...
            ImGui::PopStyleVar();
            ImGui::SameLine(contentReginAvail.x - lineHeight * 0.5f);
    ...
    void SceneHierarachyPanel::DrawComponents(Entity entity){
